...
HD_PWD='E:/Semester 4/DSD LAB/Experiment 2/Experiment_3/Experiment_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Experiment_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Experiment_3.tcl -notrace
