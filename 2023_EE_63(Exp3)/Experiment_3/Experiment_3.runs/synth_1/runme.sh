...
HD_PWD='E:/Semester 4/DSD LAB/Experiment 2/Experiment_3/Experiment_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Experiment_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Experiment_3.tcl
